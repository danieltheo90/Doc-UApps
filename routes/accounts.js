...
router.post("/register", function(req, res){
  ...
  let newUser = new User({
    ...
    if (req.body.password != req.body.confirm){
      return res.render("users/register", {message:  req.flash("error", "Passwords do not match.")});
    }
  ...
  User.register(newUser, req.body.password, function(err, user){
      ...
      passport.authenticate("local")(req, res, function(){
         req.flash("success", "Successfully Signed Up! " + req.body.username+".Please wait until your id approve by administrator") ;
         res.redirect("/");
      });
  });
});
    ...
    function(token, user, done) {
      var smtpTransport = nodemailer.createTransport({
        ...
        auth: {
          ...
          pass: 'notification@ur'
        }
      });
      var mailOptions = {
        to: user.email,
        from: 'notification.ur@gmail.com',
        subject: 'UnicoRaya Password Reset',
